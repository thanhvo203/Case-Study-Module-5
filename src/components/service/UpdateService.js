...
import {  getServiceById } from "../../services/FuramaServices";
...
function UpdateService() {
    ...
    return (
        <div>
            <Formik
                initialValues={{
                    service: service.service, usable_area: service.usable_area, costs: service.costs, max_people: service.max_people, rentalType: service.rentalType,
                    standard: service.standard, description: service.description, typeRoom: service.typeRoom, pool: service.pool, floor: service.floor, free: service.free
                }}
                ...
                onSubmit={async (service) => {
                    ...
                    updateCustomer(newService).then(() => {
                        Swal.fire({
                            icon: 'success',
                                            ...
                                            <div className="input-group" style={{ width: '245px' }}>
                                                ...
                                                <div className="input-group-icon">
                                                    <Field name="rentalType" id="rentalType" as="select" className="input--style-4" style={{ width: '250px', height: '35px' }}>
                                                        ...
                                                        {Array.isArray(rentals) && rentals.map((type => {
                                                            return (
                                        ...
                                        <div className="col-2" style={{ marginRight: '180px' }}>
                                            <div className="input-group" style={{ width: '260px' }}>
                                                ...
                                                <Field name="typeRoom" id="typeRoom" as="select" className="input--style-4" style={{ width: '250px', height: '35px' }}>
                                                    <option value={''}>Choose option</option>
                                                    {Array.isArray(typeRooms) && typeRooms.map((type => {
                                                        return (
                                                            <option key={type.id} value={type.id}>{type.type}</option>
                                                        )
                                                    }))}
